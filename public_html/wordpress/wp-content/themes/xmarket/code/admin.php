...
function etheme_add_admin_menu() {
	...
	add_menu_page(ETHEME_THEME_NAME.' Theme Options', ETHEME_THEME_NAME, 'manage_options', 'ethemesoptions', 'etheme_theme_settings_admin', ETHEME_CODE_CSS_URL.'/images/etheme.png', '58.996');
