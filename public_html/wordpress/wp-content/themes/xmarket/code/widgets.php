...
class Etheme_Subcategories_Widget extends WP_Widget {
    ...
    function widget() {
        ...
        if(class_exists('WP_eCommerce')) {
            etheme_get_categories_menu();
        }
        if(class_exists('Woocommerce')){
            etheme_get_wc_categories_menu();
        }
        echo $after_widget;
    }
}
...
class Etheme_Twitter_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
        ...
        echo etheme_print_tweets($attr['usernames'], $attr['limit'], 50);
		echo $after_widget;
	}
	...
	function form( $instance ) {
		...
		etheme_widget_input_text( __('Twitter username:', ETHEME_DOMAIN), $this->get_field_id( 'usernames' ), $this->get_field_name( 'usernames' ), $instance['usernames'] );
