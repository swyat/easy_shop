...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				...
				<?php if ( ! empty( $post->post_parent ) ) : ?>
					<p><a href="<?php echo get_permalink( $post->post_parent ); ?>" title="<?php echo esc_attr( sprintf( __( 'Return to %s', ETHEME_DOMAIN ), strip_tags( get_the_title( $post->post_parent ) ) ) ); ?>" rel="gallery"><?php
