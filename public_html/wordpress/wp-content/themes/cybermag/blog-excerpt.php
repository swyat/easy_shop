	...
	if( $blog_query->have_posts() ) :
		...
		if( $wp_query->max_num_pages > 1 ) :
			...
			<div class="navigation">
				<div class="previous"><?php next_posts_link( __( '&#8249; Older posts', 'cybermag' ), $wp_query->max_num_pages ); ?></div>
				<div class="next"><?php previous_posts_link( __( 'Newer posts &#8250;', 'cybermag' ), $wp_query->max_num_pages ); ?></div>
