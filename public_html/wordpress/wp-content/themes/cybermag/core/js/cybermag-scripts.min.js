...
a("h1.post-title").html():"&nbsp;";a(".main-nav").append('<a id="cybermag_menu_button"></a>');a(".main-nav").prepend('<div id="cybermag_current_menu_item">'+d+"</div>");a("a#cybermag_menu_button, #cybermag_current_menu_item").click(function(){a(".js .main-nav .menu").slideToggle(function(){a(this).is(":visible")?a("a#cybermag_menu_button").addClass("cybermag-toggle-open"):(a("a#cybermag_menu_button").removeClass("cybermag-toggle-open"),a(".js .main-nav .menu").removeAttr("style"))})})})(jQuery);
(function(a){a("html").click(function(){a("a#cybermag_menu_button").hasClass("cybermag-toggle-open")&&a(".js .main-nav .menu").slideToggle(function(){a("a#cybermag_menu_button").removeClass("cybermag-toggle-open");a(".js .main-nav .menu").removeAttr("style")})})})(jQuery);jQuery(".main-nav").click(function(a){"/wp-admin/customize.php"!=window.location.pathname&&a.stopPropagation()});jQuery(function(){jQuery("input[placeholder], textarea[placeholder]").placeholder()});jQuery(document).ready(function(){jQuery("#wrapper").fitVids()});