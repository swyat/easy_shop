...
(function ($) {
	...
	;
	$('.main-nav').append('<a id="cybermag_menu_button"></a>');
	$('.main-nav').prepend('<div id="cybermag_current_menu_item">' + current + '</div>');
	$('a#cybermag_menu_button, #cybermag_current_menu_item').click(function () {
		$('.js .main-nav .menu').slideToggle(function () {
			if ($(this).is(':visible')) {
				$('a#cybermag_menu_button').addClass('cybermag-toggle-open');
			}
			else {
				$('a#cybermag_menu_button').removeClass('cybermag-toggle-open');
...
(function ($) {
	$('html').click(function () {
		...
		if ($('a#cybermag_menu_button').hasClass('cybermag-toggle-open')) {
			$('.js .main-nav .menu').slideToggle(function () {
				$('a#cybermag_menu_button').removeClass('cybermag-toggle-open');
				$('.js .main-nav .menu').removeAttr('style');
			});
